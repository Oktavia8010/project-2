...
<head>
    ...
    <title>projcet CRUD - Perbaruhi Data</title>
...
<nav class="navbar navbar-expand-lg navbar-light bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand text-uppercase text-light mx-5 fw-bold" href="index.php">Oktavia Kusuma</a>
        </div>
    </nav>
    <div class="container">
        <?php
        ...
        <h2 class="mt-5 text-center">Perbaruhi Data Siswa</h2>
        ...
        <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="POST" enctype="multipart/form-data">
            <div class="form-group mt-5">
                ...
                <img src="foto/<?php echo $data["foto"]; ?>" style="width: 100px !important;" alt="">
